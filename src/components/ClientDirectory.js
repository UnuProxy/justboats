      ...
      <div className={modalClasses.container} onClick={e => e.stopPropagation()}>
        ...
        <div className={modalClasses.content}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Notes (Likes/Dislikes)</label>
              <textarea
                name="notes"
...
const ClientDirectory = () => {
  ...
  const renderBookingHistory = (client) => {
    ...
    return (
      <div className="mt-4 space-y-3"><h4 className="font-medium">Booking History</h4>
