...
import { Bell, CreditCard, Gift, Calendar, User, AlertCircle, Clock, Ship } from 'lucide-react';
...
const NotificationsCenter = () => {
  ...
  useEffect(() => {
    // Query last 50 notifications, ordered by timestamp
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case 'transfer':
        return <Ship className="text-cyan-500" />;
      case 'reminder':
